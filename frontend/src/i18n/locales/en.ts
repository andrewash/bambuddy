export default {
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      scannerDbNote: "Community database lookups follow the Barcode Scan setting in the main Bambuddy app. Matches against your own inventory always work, even offline.",
      tabUpdates: 'Updates',
      // Device tab
